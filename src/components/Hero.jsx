...
const Hero = () => {
    ...
    useGSAP(() => {
        gsap.set('#video-frame', {
            clipPath: 'polygon(14% 0%, 72% 0%, 90% 80%, 0% 100%)',
  ...
  return (
    ...
    <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
            ...
            <Button id="watch-trailer" title="Wacth Trailer" leftIcon={<TiLocationArrow />} containerClass="!bg-yellow-300 flex-center gap-1" />
            </div>
        </div>
    </div>
